...
export class AxiosAdapter {
  static get<R=any> (url: string, config?: AxiosRequestConfig) {
    return new AxiosMethod<R>(axios.get<any, AxiosResponse<R>>(url, config));
  }
  
  static post<D=any, R=any> (url: string, data?: D, config?: AxiosRequestConfig) {
    return new AxiosMethod<R>(axios.post<D, AxiosResponse<R>>(url, data, config));
  }
  
  static patch<D=any, R=any> (url: string, data?: D, config?: AxiosRequestConfig) {
    return new AxiosMethod<R>(axios.patch<D, AxiosResponse<R>>(url, data, config));
  }
  
  static delete<R=any> (url: string, config?: AxiosRequestConfig) {
    return new AxiosMethod<R>(axios.delete<any, AxiosResponse<R>>(url, config));
  }
  
  static put<D=any, R=any> (url: string, data?: D, config?: AxiosRequestConfig) {
